...
const NavBar = ({toggleClass, logo}) => {
  ...
  return (
    ...
    <div className='nav'>
      ...
      <Link className={toggleClass ? "navlink" : "navlink-light"} to="/streamtv">Stream TV</Link>
      <Link className={toggleClass ? "navlink" : "navlink-light"} to="/smartdevices">Smart Devices</Link>
      <Link className={toggleClass ? "navlink" : "navlink-light"} to="/power">Power</Link>
      <Link className={toggleClass ? "navlink" : "navlink-light"} to="/charging">Charging</Link>
      <Link className={toggleClass ? "navlink" : "navlink-light"} to="/audio">Audio</Link>
      <Link className={toggleClass ? "navlink" : "navlink-light"} to="/tools">Tools</Link>
      <Link className={toggleClass ? "navlink" : "navlink-light"} to="/support">Support</Link>
